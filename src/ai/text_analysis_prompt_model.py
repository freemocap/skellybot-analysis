...
class TextAnalysisPromptModel(BaseModel):
    ...
    relevant: bool = Field(description="A boolean flag that indicates whether the contentent of this text is relevant to the instructions, or whether it is off topic or incomplete (i.e. a conversation that doesn't progress past greetings, or a text that is just a list of questions, etc.) If this is True, set the other content to be 'N/A'")
